    ...
    return (
        ...
        >
            ...
            <div className="relative h-48 -mx-6 -mt-6 mb-4 overflow-hidden bg-gradient-to-br from-primary/20 to-warm-gold/20">
                ...
                {/* Overlay on hover */}
                <div className="absolute inset-0 bg-dark-charcoal/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center gap-4">
                    {project.demoUrl && (
                        <Link
                            href={project.demoUrl}
                            className="p-3 bg-white rounded-full text-dark-charcoal hover:bg-primary hover:text-white transition-colors"
