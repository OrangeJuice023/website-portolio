    ...
    return (
        ...
        >
            ...
            <div className="relative h-48 -mx-6 -mt-6 mb-4 overflow-hidden bg-gradient-to-br from-primary/20 to-warm-gold/20">
                ...
                {/* Status badge */}
                {project.status && (
                    <div className={`absolute top-4 right-4 px-5 py-1.5 rounded-full text-[9px] md:text-[10px] font-bold uppercase tracking-wider whitespace-nowrap z-10 ${project.status === 'Completed'
                ...
                {/* Featured badge */}
                {project.featured && (
                    <div className="absolute top-4 left-4 px-5 py-1.5 rounded-full text-[9px] md:text-[10px] font-bold uppercase tracking-wider bg-earth-brown text-white shadow-md whitespace-nowrap flex items-center gap-1 z-10">
                        ⭐ Featured
                    </div>
                )}
